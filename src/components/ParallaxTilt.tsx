    ...
    <div className="p-24 perspective-[800px]" onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
      ...
      >
        ...
        <svg viewBox="0 0 200 200"
             xmlns="http://www.w3.org/2000/svg"
             className="box" style={{top: -100, left: -60, transform: "translate3d(0, 0, 40px)"}}
             width="650px"
             height="650px"
        >
          <path fill="#F05D5E" d="M25.1,-46.5C32.5,-39.3,38.2,-32.3,47.9,-24.6C57.7,-16.9,71.5,-8.4,74.7,1.9C77.9,12.1,70.5,24.3,63.4,36.6C56.3,48.9,49.4,61.3,38.9,68.8C28.4,76.3,14.2,78.9,2.3,74.8C-9.5,70.7,-19,60,-33.3,54.7C-47.6,49.4,-66.8,49.5,-72.4,41.3C-77.9,33.1,-69.9,16.5,-68,1.1C-66.2,-14.4,-70.5,-28.8,-64.8,-36.9C-59.2,-45,-43.6,-46.8,-31.2,-51C-18.7,-55.2,-9.4,-61.8,-0.2,-61.5C8.9,-61.1,17.8,-53.7,25.1,-46.5Z" transform="translate(100 100)" />
        </svg>
       
        <svg viewBox="0 0 200 200"
             xmlns="http://www.w3.org/2000/svg"
             className="box" style={{ transform: "translate3d(0, 0, 80px)"}}
             width="500px"
             height="500px"
        >
       ...
       <svg viewBox="0 0 200 200"
             xmlns="http://www.w3.org/2000/svg"
             className="box" style={{top: 60, left: 60, transform: "translate3d(0, 0, 120px)"}}
             width="350px"
             height="350px"
        >
          <path fill="#E7ECEF" d="M42.1,-71.8C56.1,-64.8,70,-56.6,77.4,-44.5C84.9,-32.3,85.8,-16.2,81.1,-2.7C76.4,10.8,66.2,21.5,59,34.1C51.8,46.7,47.7,61.1,38.4,70.8C29.1,80.4,14.5,85.3,1.6,82.5C-11.3,79.7,-22.5,69.1,-34,60.7C-45.4,52.2,-56.9,45.9,-65.6,36.1C-74.3,26.4,-80.1,13.2,-81.6,-0.9C-83.2,-15,-80.5,-29.9,-73.4,-42.6C-66.4,-55.3,-55.2,-65.6,-42.2,-73.2C-29.3,-80.8,-14.6,-85.7,-0.3,-85.1C14,-84.6,28.1,-78.8,42.1,-71.8Z" transform="translate(100 100)" />
        </svg>

        <svg viewBox="0 0 200 200"
             xmlns="http://www.w3.org/2000/svg"
             className="box" style={{top: 110, left: 130,  transform: "translate3d(0, 0, 160px)"}}
             width="200px"
             height="200px"
        >
          <path fill="#272932" d="M25.7,-49C33.6,-39.9,40.5,-33.7,47.4,-26C54.3,-18.3,61.2,-9.1,64.6,2C68.1,13.1,68.2,26.3,65.1,40.5C62,54.8,55.7,70.2,44.3,73.7C32.9,77.1,16.5,68.6,3.3,62.9C-9.8,57.1,-19.7,54.1,-31,50.7C-42.4,47.2,-55.4,43.3,-63.8,34.8C-72.2,26.3,-76,13.1,-76.8,-0.4C-77.6,-14,-75.3,-28.1,-66.3,-35.5C-57.2,-43,-41.5,-43.8,-29.3,-50.4C-17.2,-57,-8.6,-69.5,0.2,-69.7C8.9,-70,17.8,-58.1,25.7,-49Z" transform="translate(100 100)" />
        </svg>

        <svg viewBox="0 0 200 200" 
             xmlns="http://www.w3.org/2000/svg"
             className="box" style={{top: 200, left: 200,  transform: "translate3d(0, 0, 200px)"}}
             width="50px"
             height="50px"
        >
